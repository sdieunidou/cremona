...
export const blogPostDefaultCopy = {
  title: "How we built our API",
} as const;
...
export interface BlogPostProps extends VisualProps {
  title?: string;
  gradient?: boolean;
  fadeOut?: boolean;
  isometric?: boolean;
...
export function BlogPost({
  title = blogPostDefaultCopy.title,
  animated = false,
  trigger = "inView",
  gradient = true,
  fadeOut = false,
      ...
      >
        <div className="relative p-1.5">
          ...
          <div className="relative rounded-xl border bg-card px-10 py-5 shadow-xs">
            ...
            >
              <motion.p
                className="text-[10px] leading-[1.2] font-semibold text-foreground"
