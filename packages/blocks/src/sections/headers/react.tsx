...
export const headersDefaultCopy = {
  title: "Acme",
} as const;
    ...
    >
      ...
      >
        <div className="relative p-1.5">
          ...
          <div className="relative rounded-xl border bg-card p-2.5 shadow-xs">
            <motion.div
              className="flex items-center gap-2 rounded-lg border border-border/50 bg-muted/35 px-2 py-1.5"
              variants={animated ? nav : undefined}
              {...state}
            >
              <motion.div
            ...
            <motion.div
              className="mt-3.5 flex flex-col items-center pb-1"
              variants={animated ? hero : undefined}
              {...state}
            >
              ...
              <div className="mt-1.5 flex w-full flex-col items-center gap-1">
                ...
                <div className="h-0.75 w-2/5 rounded-full bg-muted-foreground/15" />
              </div>
              <div className="mt-2 flex gap-1">
                <div className="h-2.5 w-7 rounded-md bg-primary/80" />
                <div className="h-2.5 w-6 rounded-md border" />
              </div>
            </motion.div>
          </div>
        </div>
