...
export interface AuthProps extends VisualProps {
  title?: string;
  gradient?: boolean;
  fadeOut?: boolean;
  isometric?: boolean;
    ...
    >
      ...
      >
        <div className="relative p-1.5">
          ...
          <div className="relative rounded-xl border bg-card px-12 py-5 shadow-xs">
            <motion.div
            ...
            >
              <motion.div
                className="mb-2 flex size-5 items-center justify-center rounded-lg bg-primary/10 ring-1 ring-primary/15 ring-inset"
              ...
              <motion.div
                ...
                variants={animated ? item : undefined}
              >
                <div className="h-0.75 w-2/3 rounded-full bg-muted-foreground/20" />
              </motion.div>
            </motion.div>
            <motion.div
            ...
            >
              <div className="flex gap-1.5">
                <div className="flex h-4 flex-1 items-center justify-center rounded-md border bg-muted/20">
                  <div className="h-0.75 w-5 rounded-full bg-muted-foreground/25" />
                </div>
                <div className="flex h-4 flex-1 items-center justify-center rounded-md border bg-muted/20">
                  <div className="h-0.75 w-5 rounded-full bg-muted-foreground/25" />
                </div>
              ...
              <div className="flex flex-col gap-1">
                <div className="h-0.5 w-6 rounded-full bg-foreground/12" />
                <div className="h-3.5 rounded-md border bg-muted/20" />
              </div>
              <div className="flex flex-col gap-1">
                <div className="flex items-center justify-between">
                  <div className="h-0.5 w-8 rounded-full bg-foreground/12" />
                  <div className="h-0.5 w-5 rounded-full bg-primary/30" />
                </div>
                <div className="h-3.5 rounded-md border bg-muted/20" />
              </div>
              <div className="mt-0.5 flex h-4 items-center justify-center rounded-md bg-primary">
                <div className="h-0.5 w-8 rounded-full bg-primary-foreground/80" />
              </div>
