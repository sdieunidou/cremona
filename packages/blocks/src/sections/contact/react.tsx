...
export const contactDefaultCopy = {
  title: "Get in Touch",
} as const;
...
export interface ContactProps extends VisualProps {
  title?: string;
  gradient?: boolean;
  fadeOut?: boolean;
  isometric?: boolean;
...
export function Contact({
  title = contactDefaultCopy.title,
  animated = false,
  trigger = "inView",
  gradient = true,
  fadeOut = false,
    ...
    >
      ...
      >
        <div className="relative p-1.5">
          ...
          <div className="relative rounded-xl border bg-card px-10 py-5 shadow-xs">
            <motion.div
            ...
            <motion.div className="mt-3 flex gap-2" variants={animated ? form : undefined} {...state}>
              <div className="flex flex-1 flex-col gap-1.5">
                ...
                <div className="flex h-3 max-w-8 items-center rounded-md bg-primary px-1.5">
              ...
              <div className="flex flex-1 flex-col gap-2">
                ...
                <div className="mt-auto h-8 rounded-lg bg-muted/50" />
              </div>
            </motion.div>
          </div>
        </div>
