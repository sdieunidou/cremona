...
import { Calendar, CreditCard, MessageCircle, Music, Send, Zap } from "lucide-react";
...
// logo + satellites for the custom-icons / brand-logos variants (from the POC page chunk)
const zapLogo = <Zap className="size-6 text-primary-foreground" strokeWidth={1.75} />;
